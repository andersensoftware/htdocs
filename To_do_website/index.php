...
<div id = "container">
	...
	<div class="header">
		...
		<div id = "box">
			 <div id = "sses2">
				<ul>
					<li><a href="php/login.php">Log ind</a></li>
					<li><a href="php/register.php">Register</a></li>
					<li><a href="php/contact.php">Contact form</a></li>
				</ul>
	...
	<?php else: ?>
		...
		<h1>Welcome to our To_Do_Website</h1>
		<h2>About our site. please contact us if your interested using the contact form</h2>
		<a>
			Text about us and our site
		</a>
